...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                @auth
                <a href="javascript:void(0)" class="d-block">{{ucfirst(auth()->user()->first_name) . " ".
                    ucfirst(auth()->user()->last_name)}}</a>
                @endauth
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{route('admin.company.view')}}" class="nav-link active">
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">System Companys</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Comapnys</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<script type="text/javascript">
    $(document).ready(() => {
        $('#table-companys').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'web', name: 'web'},
                        {data: 'fb_page', name: 'fb_page'},
                        {data: 'registor_date', name: 'registor_date'},
                        {data: "company_id" , render : function ( data, type, row, meta ) {
                return type === 'display'  ?
                    '<button class="btn btn-danger" onClick="deleteCompany('+data+')">Delete</button>' :
                    data;
                }}  
                    ]
            });
    ...
    function load_table() {
        let table = $('#table-companys').DataTable();
        table.ajax.reload();
    }
</script>
