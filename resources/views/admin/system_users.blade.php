...
<script type="text/javascript">
    $(document).ready(() => {
        $('#table-companys').DataTable({
                ...
                return type === 'display'  ?
                    '<button class="btn btn-primary" onClick="findUsers('+data+')">Find</button>' :
                    data;
                }}  
                    ]
            });
    ...
    function findUsers(params) {
        ...
        $('#company-users').DataTable({
                ...
                return type === 'display'  ?
                    '<button class="btn btn-danger" onClick="deleteUsers('+data+')">Delete</button>' :
                    data;
                }}  
                    ]
            });
