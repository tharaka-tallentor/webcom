                ...
                <div class="row">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <p class="text-muted text-center">
                                    {{ session()->get('company_user.industry.industry_name') }}
                                </p>
                                ...
                                <div id="conection-model" class="modal fade bd-example-modal-lg" tabindex="-1"
                    ...
                    <div class="col-md-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="profile-update" action="{{ route('control_panel.profile.update') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" id="address" class="form-control" rows="8">{{ session()->get('company_user.company.address') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="country" id="country" class="form-control">
                                                    @foreach ($country as $key => $data)
                                                        <option value="{{ $data->country_id }}">{{ $data->country }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
